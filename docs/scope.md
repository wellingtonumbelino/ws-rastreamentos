...
- Simular o funcionamento de um site de rastreio
...
Elementos presentes no topo da aplicação:
...
Seção principal da página contendo:

- Mensagem principal do sistema
- Descrição breve
- Elemento principal de interação com o usuário

### Área Principal / Conteúdo

Ações de interação com o usuário como:
...
- Realizar busca por código seguindo um padrão de código (ex.: AAA0000AA)

### Fluxo Básico do Projeto

- O usuário realiza a ação de buscar pelo pacote através de um código de rastreio
